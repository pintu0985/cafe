/**
 * FAIRY LIGHTS HOUSE CAFE AJMER — RESERVATION ENGINE
...
function initReservationForm() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Generate Reference ID: FLH-2026-XXXX
        const randomNum = Math.floor(1000 + Math.random() * 9000);
        const referenceId = `FLH-2026-${randomNum}`;
